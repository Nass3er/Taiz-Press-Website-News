            ...
            <div class="col-lg-12">
                <div class="card" >
                    <div class="card-header">
                        <h4> 
                            <i class="fa fa-align-justify"></i> {{trans('words.trash')}}
                            
                            @if(auth()->user()->status == 'admin')
                            <a href="{{ route('dashboard.trash.deleteAll') }}" class="btn btn-primary mt-1" style="float: inline-end;background-color: #03248f;"> {{ trans('words.delete all') }}</a>
                            @endif
                        </h4>
...
<div class="modal-dialog">
    <form action="{{ Route('dashboard.trash.delete') }}" method="POST">
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#table_id').DataTable({
                ...
                ajax: "{{ Route('dashboard.trash.all') }}",
                columns: [
