...
@section('css')
<!--  Owl-carousel css-->
<link href="{{URL::asset('adminassets2/plugins/owl-carousel/owl.carousel.css')}}" rel="stylesheet" />
<!-- Maps css -->
<link href="{{URL::asset('adminassets2/plugins/jqvmap/jqvmap.min.css')}}" rel="stylesheet">
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{trans('words.welcome back')}} ..</h2>
						  <p class="mg-b-0">{{trans('words.Site progress monitoring panel')}}</p>
						</div>
					</div>
					<div class="main-dashboard-header-right">
						 
						<div>
							<label class="tx-13">{{trans('words.total visitors')}}</label>
							<h5>{{$totalvisitorsCount}}</h5>
						</div>
						<div>
							<label class="tx-13">{{trans('words.today visitors')}}</label>
							<h5>{{$todayvisitorsCount}}</h5>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{trans('words.week views')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{trans('words.total')}}: {{ array_sum($viewsCounts) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{trans('words.compare')}}</p>
										</div>
							...
							<span id="compositeline" class="pt-1"> {{ $viewsCountsString }}</span>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white"> {{trans('words.today views')}}    </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{trans('words.total')}}:33</h4>
											<p class="mb-0 tx-12 text-white op-7">{{trans('words.compare')}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{trans('words.week posts')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{trans('words.total')}}:60</h4>
											<p class="mb-0 tx-12 text-white op-7">{{trans('words.compare')}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{trans('words.today posts')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{trans('words.total')}}:11</h4>
											<p class="mb-0 tx-12 text-white op-7">{{trans('words.compare')}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
								...
								<div class="list-group list-lg-group list-group-flush">
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{URL::asset('adminassets2/img/faces/3.jpg')}}" alt="Image description">
									...
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{URL::asset('adminassets2/img/faces/11.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
									...
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{URL::asset('adminassets2/img/faces/17.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
									...
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{URL::asset('adminassets2/img/faces/15.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
									...
									<div class="list-group-item list-group-item-action br-br-7 br-bl-7" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{URL::asset('adminassets2/img/faces/6.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
...
<script src="{{URL::asset('adminassets2/plugins/chart.js/Chart.bundle.min.js')}}"></script>
<!-- Moment js -->
<script src="{{URL::asset('adminassets2/plugins/raphael/raphael.min.js')}}"></script>
<!--Internal  Flot js-->
<script src="{{URL::asset('adminassets2/plugins/jquery.flot/jquery.flot.js')}}"></script>
<script src="{{URL::asset('adminassets2/plugins/jquery.flot/jquery.flot.pie.js')}}"></script>
<script src="{{URL::asset('adminassets2/plugins/jquery.flot/jquery.flot.resize.js')}}"></script>
<script src="{{URL::asset('adminassets2/plugins/jquery.flot/jquery.flot.categories.js')}}"></script>
<script src="{{URL::asset('adminassets2/js/dashboard.sampledata.js')}}"></script>
<script src="{{URL::asset('adminassets2/js/chart.flot.sampledata.js')}}"></script>
<!--Internal Apexchart js-->
<script src="{{URL::asset('adminassets2/js/apexcharts.js')}}"></script>
<!-- Internal Map -->
<script src="{{URL::asset('adminassets2/plugins/jqvmap/jquery.vmap.min.js')}}"></script>
<script src="{{URL::asset('adminassets2/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<script src="{{URL::asset('adminassets2/js/modal-popup.js')}}"></script>
<!--Internal  index js -->
<script src="{{URL::asset('adminassets2/js/index.js')}}"></script>
<script src="{{URL::asset('adminassets2/js/jquery.vmap.sampledata.js')}}"></script>	
@endsection